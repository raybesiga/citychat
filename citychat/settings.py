"""
Django settings for citychat project.
...
SECRET_KEY = 'k%0_er5l)v77)p5h$bjcq_bn#^q7i@b#*gm*2sy!-kloz$ts(f'
...
WSGI_APPLICATION = 'citychat.wsgi.application'
